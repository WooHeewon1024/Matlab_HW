...
B = [RouteID(BatteryPerKm > 6) ...
     DistanceKm(BatteryPerKm > 6) ...
     BatteryPerKm(BatteryPerKm > 6)];
disp(B)
```
...
P.Properties.VariableNames{'culmen_length_mm'} = 'bill_length_mm';
P.Properties.VariableNames{'culmen_depth_mm'} = 'bill_depth_mm';
a = P(P.body_mass_g >= 4500,:);
a(:,{'species','island','body_mass_g','sex'})
